...
mat_avg_weights = scipy.io.loadmat(os.path.join(results_folder, f'AVG_{simulation_type}_{obs_stations_to_select}_weights.mat'))
regional_weights = mat_avg_weights['regional_weights']
mat_avg_data = scipy.io.loadmat(os.path.join(save_folder, f'AVG_{simulation_type}_{obs_stations_to_select}_ClimEx.mat'))
