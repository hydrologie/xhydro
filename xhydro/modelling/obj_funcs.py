...
def get_objective_function(Qobs, 
                       Qsim, 
                       obj_func='rmse',
                       take_negative=False,
                       mask=None, 
    ...
    """
    This function is the entrypoint for objective function calculation. More
    can be added by adding the function to this file and adding the option in 
    this function. 
    ...
    if obj_func not in obj_func_list:
        sys.exit("Selected objective function is currently unavailable. " +
...
def get_objfun_minimize_or_maximize(obj_func):
    """
    This function checks the name of the objective function and returns whether
    it should be maximized or minimized. Returns a boolean value, where True 
    means it should be maximized, and Flase means that it should be minimized.
    ...
    if obj_func in ["agreement_index",
                    "correlation_coeff",
                    "kge",
                    "kge_mod",
                    "nse",
    ...
    # Check for the metrics that exist but cannot be used for optimization
        ...
        sys.exit("The bias, pbias and volume_error metrics cannot be minimized or maximized. \
...
def get_optimizer_minimize_or_maximize(algorithm):
    """
    This function finds the direction in which the optimizer searches. Some
    optimizers try to maximize the objective function value, and others try to
    minimize it. Since our objective functions include some that need to be
    maximized and others minimized, it is imperative to ensure that the 
