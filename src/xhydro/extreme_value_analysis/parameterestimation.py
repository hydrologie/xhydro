...
from xhydro.extreme_value_analysis.structures.util import jl_variable_fit_parameters, jl_variable_fit_parameters_debug
...
def fit(
    ...
    """
    method = method.upper()
    _check_fit_params(dist, method, locationcov, logscalecov, shapecov)
