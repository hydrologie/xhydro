    ...
    """
        ...
        np.testing.assert_array_almost_equal(objfun, 0.058823529411764705, 8)

        objfun = get_objective_function(qobs, qsim, obj_func="kge_2021")
        np.testing.assert_array_almost_equal(objfun, 0.7496911301778573, 8)

        objfun = get_objective_function(qobs, qsim, obj_func="lce")
        np.testing.assert_array_almost_equal(objfun, 0.758342698998082, 8)

        objfun = get_objective_function(qobs, qsim, obj_func="low_flow_rel_error")
        np.testing.assert_array_almost_equal(objfun, -0.02666666666666667, 8)

        objfun = get_objective_function(qobs, qsim, obj_func="persistence_index")
        np.testing.assert_array_almost_equal(objfun, 0.6829268292682926, 8)
